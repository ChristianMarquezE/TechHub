        ...
        <div class="card shadow border-0" style="border-radius: 16px; background-color: #fafafa;">
            <div class="card-body p-5">
                <div class="text-center mb-4">
                    <h4 class="fw-bold text-navy"><i class="bi bi-person-circle fs-2 d-block mb-2 text-primary"></i> Iniciar Sesión</h4>
                </div>
                ...
                <form method="POST" action="<?= BASE_URL ?>usuario/login">
                    ...
                    <button type="submit" class="btn btn-primary w-100 py-2 fw-bold" style="border-radius: 8px;">Entrar al Sistema</button>
                </form>
                
                <p class="mt-4 text-center text-muted small">
                    ¿No tienes cuenta? <a href="<?= BASE_URL ?>usuario/registro" class="text-decoration-none fw-bold">Regístrate aquí</a>
                </p>
            </div>
        </div>
    </div>
